...
import com.lowdragmc.shimmer.core.mixins.compat.iris.ShaderStorageBufferAccessor;
...
public class CommonIrisHandle implements IrisHandle {
    /**
     * must have this, this is called by reflect
     */
    public CommonIrisHandle() {
    }
